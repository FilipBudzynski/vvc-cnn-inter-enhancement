...
def main():
    ...
    train_dataset = BlackfyreDataset(data_dir="data/precomputed_martell", patch_size=PATCH_SIZE, split="train")
    val_dataset = BlackfyreDataset(data_dir="data/precomputed_martell", patch_size=PATCH_SIZE, split="val")
    ...
    for epoch in range(args.epochs):
        ...
        if epoch % 10 == 0:
            ...
            torch.save(model.state_dict(), f"checkpoints/martell_epoch_{epoch}.pt")
            wandb.save(f"checkpoints/martell_epoch_{epoch}.pt")
